    ...
    for infile in infiles:
        with open(infile) as tsv_in_file:
            ...
            for item in reader:
                ...
                if len(str(path2id[item['image_id']])) == 7 and str(path2id[item['image_id']])[0] == '3':
                    s += 1
